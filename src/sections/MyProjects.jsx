      ...
      <div className="container mx-auto px-8 md:px-10 py-10">
        <div className="w-full lg:w-[60vw] mx-auto">
          ...
          <p className="text-white text-sm text-center mt-4 leading-6">
            These projects reflect my journey in software development,
            showcasing my skills in HTML, CSS, JavaScript, and more. Each one
            represents my focus on clean code, responsive design, and delivering
